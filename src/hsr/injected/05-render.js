  ...
  function createReportHtml(rows) {
    ...
    return `
      ...
      <div style="${app.styles.modalHeader}">
        <div>
          <strong style="display:flex;align-items:center;font-size:20px;line-height:1.25;">이잘키 스타레일 정오표</strong>
      ...
      <div data-jalkiwotda-report-body style="${app.styles.modalBody}">
        ...
        <table>
          <thead>
            <tr>
              <th>캐릭터</th><th>레벨</th><th>역할</th><th>광추</th><th>세트</th><th>주 옵션</th><th>스탯 목표</th><th>치명타 목표</th>
            </tr>
          </thead>
